		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Absence History Report",
									"targetURL": "#comgccreportsar02ar02report-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccreportsar02ar02report-display": {
								"semanticObject": "comgccreportsar02ar02report",
								"action": "display",
								"description": "Absence History Report.",
								"title": "Absence History Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.reports.ar02.ar02report",
									"url": sap.ui.require.toUrl("com/gcc/reports/ar02/ar02report")
								}
							}
						}
					}
