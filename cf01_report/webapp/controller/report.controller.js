sap.ui.define([
    ...
    return Controller.extend("com.gcc.report.cf01report.controller.report", {
        ...
        onOpenForm: function (oEvent) {
            ...
            sap.ui.require(["sap/ushell/Container"], async (Container) => {
                ...
                var sHref = await (oNavigationService && oNavigationService.getHref({
                    target: { semanticObject: "GCC_SemObj_cf01qa", action: "Display" },
            ...
            // var reqUrl = appUrl.includes("GCC_SemObj") ? `${flpLink}_cf01qa-Display?sap-ui-app-id-hint=09a4a63f-b3b2-45fd-8459-0bcab5398b8f&/${queryParameters}` : `${portLink}5424624e-2882-47ee-b90d-31fc14adb33f.comgccclaimsqacf01qa.comgccclaimsqacf01qa-0.0.1/index.html#${queryParameters}`;
        ...
        onDateChange: function (oEvent) {
            let r = oEvent.getParameter("valid");
        },
        ...
        onGo: function (oFilterLog1, oFilterLog2, oFilterApprover) {
            ...
            this.getOwnerComponent().getModel("ZSFGTGW_LOG_SRV").read("/zsf_logSet", {
                ...
                success: function (oData) {
                    this.fetchAdditinonalDataForItems(oData.results, oFilterCf01, oFilterApprover);
                }.bind(this),
        ...
        fetchAdditinonalDataForItems: function (aItems, filter, filterApprover) {
            var oModel = this.getView().getModel("AllData");
            var sServiceUrl = this.getOwnerComponent().getModel("ZSFGTGW_CF01_SRV").sServiceUrl;
            var tableData = [];
            ...
            aItems.forEach(function (oItem) {
                ...
                this.getOwnerComponent().getModel("ZSFGTGW_CF01_SRV").read("/zsf_cf01_hSet(Formid='" + FormId + "')", {
                    ...
                    success: function (oData) {
                        var temp = {
                            ...
                            "Initiator": Initiator,
                            "Approver": "",
                            "Claim_End_Date": oData.ClaimEndDate,
        ...
        _registerForP13n: function () {
            ...
            this.oMetadataHelper = new MetadataHelper([
                ...
                // { key: "empID_col", label: "Employee ID", path: "AllData>Employee ID" },
                // { key: "empname_col", label: "Employee Name", path: "AllData>Employee Name" },
                { key: "Claim_End_Date", label: "Claim End Date", path: "AllData>Claim_End_Date" },
        ...
        _openDialog: function (sName, sPage, fInit) {
            ...
            if (!this._mDialogs[sName]) {
                this._mDialogs[sName] = Fragment.load({
                    id: oView.getId(),
                    name: "com.gcc.report.cf01report.fragment." + sName,
                    controller: this
