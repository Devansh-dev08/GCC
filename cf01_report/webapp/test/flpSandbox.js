		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Claims Hisory Report",
									"targetURL": "#comgccreportcf01report-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccreportcf01report-display": {
								"semanticObject": "comgccreportcf01report",
								"action": "display",
								"description": "Claims Hisory Report",
								"title": "Claims Hisory Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.report.cf01report",
									"url": sap.ui.require.toUrl("com/gcc/report/cf01report")
								}
							}
						}
					}
