sap.ui.define([
    ...
    return Controller.extend("com.gcc.reports.ex01report.controller.report", {
        ...
        onOpenForm: function (oEvent) {
            ...
            sap.ui.require(["sap/ushell/Container"], async (Container) => {
                ...
                var sHref = await (oNavigationService && oNavigationService.getHref({
                    target: { semanticObject: "GCC_SemObj_EX01", action: "Display" },
        ...
        onGo: function (oFilterLog1, oFilterApprover) {
            ...
            oFilterLog.push(new Filter("Type", FilterOperator.EQ, 'EX01'));
            ...
            this.getOwnerComponent().getModel("ZSFGTGW_LOG_SRV").read("/zsf_logSet", {
                ...
                success: function (oData) {
                    this.fetchAdditinonalDataForItems(oData.results);
                }.bind(this),
        ...
        fetchAdditinonalDataForItems: function (aItems) {
            var oModel = this.getView().getModel("AllData");
            var tableData = [];
            ...
            if (aItems.length == 0) {
                ...
                aItems.forEach(function (oItem) {
                    ...
                    this.getOwnerComponent().getModel("ZSFGTGW_EX01_SRV").read("/zsf_ex01_hSet(Formid='" + FormId + "')", {
                        success: function (oData) {
                            var temp = {
                                "Form_ID": FormId,
                                "Status": Status,
                                ...
                                "Initiator": Initiator,
                                "Approver": "",
                                "ClaimEndDate": oData.ClaimEndDate,
                                "Personnel_Area": oItem.OrganizationName,
        ...
        _registerForP13n: function () {
            ...
            this.oMetadataHelper = new MetadataHelper([
                ...
                { key: "ClaimEndDate", label: "Claim End Date", path: "AllData>ClaimEndDate" },
        ...
        _openDialog: function (sName, sPage, fInit) {
            ...
            if (!this._mDialogs[sName]) {
                this._mDialogs[sName] = Fragment.load({
                    id: oView.getId(),
                    name: "com.gcc.reports.ex01report.fragment." + sName,
                    controller: this
