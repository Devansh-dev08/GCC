		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "School Expenses History Report",
									"targetURL": "#comgccreportsex01report-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccreportsex01report-display": {
								"semanticObject": "comgccreportsex01report",
								"action": "display",
								"description": "School Expenses History Report",
								"title": "School Expenses History Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.reports.ex01report",
									"url": sap.ui.require.toUrl("com/gcc/reports/ex01report")
								}
							}
						}
					}
