		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "New Starter History Report",
									"targetURL": "#comgccreportsns01ns01report-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccreportsns01ns01report-display": {
								"semanticObject": "comgccreportsns01ns01report",
								"action": "display",
								"description": "New Starter History Report",
								"title": "New Starter History Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.reports.ns01.ns01report",
									"url": sap.ui.require.toUrl("com/gcc/reports/ns01/ns01report")
								}
							}
						}
					}
