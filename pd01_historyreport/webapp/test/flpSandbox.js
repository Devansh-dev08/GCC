		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PD01 History Report",
									"targetURL": "#pd01historyreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pd01historyreport-display": {
								"semanticObject": "pd01historyreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pd01historyreport",
									"url": sap.ui.require.toUrl("pd01historyreport")
								}
							}
						}
					}
