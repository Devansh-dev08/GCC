		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comgccabsenceqaar02qa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccabsenceqaar02qa-display": {
								"semanticObject": "comgccabsenceqaar02qa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.absenceqa.ar02qa",
									"url": sap.ui.require.toUrl("com/gcc/absenceqa/ar02qa")
								}
							}
						}
					}
