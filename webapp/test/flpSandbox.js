		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comgccpensionqaps03qa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccpensionqaps03qa-display": {
								"semanticObject": "comgccpensionqaps03qa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.pensionqa.ps03qa",
									"url": sap.ui.require.toUrl("com/gcc/pensionqa/ps03qa")
								}
							}
						}
					}
