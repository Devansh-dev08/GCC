		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Schools Claims Form",
									"targetURL": "#comgccclaimsqacf01qa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccclaimsqacf01qa-display": {
								"semanticObject": "comgccclaimsqacf01qa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.claimsqa.cf01qa",
									"url": sap.ui.require.toUrl("com/gcc/claimsqa/cf01qa")
								}
							}
						}
					}
