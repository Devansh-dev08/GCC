		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comgcceformssettingsappsettingsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgcceformssettingsappsettingsapp-display": {
								"semanticObject": "comgcceformssettingsappsettingsapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.eforms.settingsapp.settingsapp",
									"url": sap.ui.require.toUrl("com/gcc/eforms/settingsapp/settingsapp")
								}
							}
						}
					}
