		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comgcceformsex02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgcceformsex02-display": {
								"semanticObject": "comgcceformsex02",
								"action": "display",
								"description": "Police Expenses Form",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.eforms.ex02",
									"url": sap.ui.require.toUrl("com/gcc/eforms/ex02")
								}
							}
						}
					}
