		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comgccnewstarterqanewstarterqa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgccnewstarterqanewstarterqa-display": {
								"semanticObject": "comgccnewstarterqanewstarterqa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.newstarterqa.newstarterqa",
									"url": sap.ui.require.toUrl("com/gcc/newstarterqa/newstarterqa")
								}
							}
						}
					}
