		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Schools Expense Form",
									"targetURL": "#comgcceformsex01ex01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgcceformsex01ex01-display": {
								"semanticObject": "comgcceformsex01ex01",
								"action": "display",
								"description": "Schools Expense Form",
								"title": "Schools Expense Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gcc.eforms.ex01.ex01",
									"url": sap.ui.require.toUrl("com/gcc/eforms/ex01/ex01")
								}
							}
						}
					}
